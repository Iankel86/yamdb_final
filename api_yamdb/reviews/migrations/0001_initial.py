    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Поставьте оценку от 1 до 10'), django.core.validators.MaxValueValidator(10, 'Поставьте оценку от 1 до 10')], verbose_name='Оценка')),
